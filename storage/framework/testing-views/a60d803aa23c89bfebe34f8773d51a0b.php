<?php
if (!function_exists('_a60d803aa23c89bfebe34f8773d51a0b')):
function _a60d803aa23c89bfebe34f8773d51a0b($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__attrsd8f3101483a683c0a3f34bd3c7413d07 = ['tooltip' => $tooltip,'attributes' => $attributes]; ?>
...
<?php $__attrs0e5cde04e1ccdd4ef673892b673d1443 = ['attributes' => $attributes->class($classes)->merge($circle ? ['data-circle' => 'true'] : []),'as' => $as,'href' => $href,'dataFluxAvatar' => true,'dataSlot' => 'avatar','dataSize' => e($size)]; ?>
...
<?php _30c086465a738807bc38961e7a562afb($__blaze, ['name' => $icon,'variant' => $iconVariant,'class' => $iconClasses], [], ['name', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _0e5cde04e1ccdd4ef673892b673d1443($__blaze, $__attrs0e5cde04e1ccdd4ef673892b673d1443, $__slots0e5cde04e1ccdd4ef673892b673d1443, ['attributes', 'as', 'href', 'dataFluxAvatar'], ['dataFluxAvatar' => 'data-flux-avatar', 'dataSlot' => 'data-slot', 'dataSize' => 'data-size'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php _d8f3101483a683c0a3f34bd3c7413d07($__blaze, $__attrsd8f3101483a683c0a3f34bd3c7413d07, $__slotsd8f3101483a683c0a3f34bd3c7413d07, ['tooltip', 'attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH D:\laragon\www\SIMOPRAM-1\vendor\livewire\flux\src/../stubs/resources/views/flux/avatar/index.blade.php ENDPATH**/ ?>