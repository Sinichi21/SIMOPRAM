<?php # [BlazeFolded]:{flux::sidebar.backdrop}:{D:\laragon\www\SIMOPRAM-1\vendor\livewire\flux\src/../stubs/resources/views/flux/sidebar/backdrop.blade.php}:{1788140904} ?>
<?php
if (!function_exists('_1c680d3ae746ca1214d0ee513bd247aa')):
function _1c680d3ae746ca1214d0ee513bd247aa($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
} endif; ?><?php /**PATH D:\laragon\www\SIMOPRAM-1\vendor\livewire\flux\stubs\resources\views\flux\sidebar\index.blade.php ENDPATH**/ ?>