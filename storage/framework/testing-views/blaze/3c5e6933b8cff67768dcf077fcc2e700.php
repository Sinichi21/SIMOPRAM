<?php
if (!function_exists('__3c5e6933b8cff67768dcf077fcc2e700')):
function __3c5e6933b8cff67768dcf077fcc2e700($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if (!function_exists('__d8f3101483a683c0a3f34bd3c7413d07')) { $__blaze->compile('D:\laragon\www\SIMOPRAM-1\vendor\livewire\flux\src/../stubs/resources/views/flux/with-tooltip.blade.php', $__blaze->compiledPath.'/d8f3101483a683c0a3f34bd3c7413d07.php'); require $__blaze->compiledPath.'/d8f3101483a683c0a3f34bd3c7413d07.php'; } ?>
...
<?php $__attrs300b9e6abc57383b675a2b483dbe84cb = ['type' => $type,'attributes' => $attributes->class($classes),'dataFluxButton' => true]; ?>
...
<?php __30c086465a738807bc38961e7a562afb($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php endif; ?>
...
<?php __30c086465a738807bc38961e7a562afb($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        <?php elseif ($iconTrailing): ?>
            <?php echo e($iconTrailing); ?>

        <?php endif; ?>
    <?php $__slots300b9e6abc57383b675a2b483dbe84cb['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots300b9e6abc57383b675a2b483dbe84cb); ?>
<?php __300b9e6abc57383b675a2b483dbe84cb($__blaze, $__attrs300b9e6abc57383b675a2b483dbe84cb, $__slots300b9e6abc57383b675a2b483dbe84cb, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
...
<?php $__blaze->popData(); ?>
<?php $__slotsd8f3101483a683c0a3f34bd3c7413d07['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsd8f3101483a683c0a3f34bd3c7413d07); ?>
<?php __d8f3101483a683c0a3f34bd3c7413d07($__blaze, $__attrsd8f3101483a683c0a3f34bd3c7413d07, $__slotsd8f3101483a683c0a3f34bd3c7413d07, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
...
} endif; ?><?php /**PATH D:\laragon\www\SIMOPRAM-1\vendor\livewire\flux\src/../stubs/resources/views/flux/button/index.blade.php ENDPATH**/ ?>